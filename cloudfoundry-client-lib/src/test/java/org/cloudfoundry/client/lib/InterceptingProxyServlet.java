...
/**
 * An http proxy implementation that counts number of received requests
 */
public class InterceptingProxyServlet extends ProxyServlet {
    ...
    public InterceptingProxyServlet(HttpProxyConfiguration httpProxyConfiguration, AtomicInteger nbReceivedRequests) {
